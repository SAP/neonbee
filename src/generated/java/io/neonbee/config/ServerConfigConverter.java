...
/**
 * Converter and mapper for {@link io.neonbee.config.ServerConfig}.
 * NOTE: This class has been automatically generated from the {@link io.neonbee.config.ServerConfig} original class using Vert.x codegen.
 */
      ...
      switch (member.getKey()) {
        ...
        case "correlationStrategy":
          if (member.getValue() instanceof String) {
            obj.setCorrelationStrategy(io.neonbee.config.ServerConfig.CorrelationStrategy.valueOf((String)member.getValue()));
          }
          break;
        ...
        case "sessionHandling":
          if (member.getValue() instanceof String) {
            obj.setSessionHandling(io.neonbee.config.ServerConfig.SessionHandling.valueOf((String)member.getValue()));
          }
          break;
        case "timeout":
