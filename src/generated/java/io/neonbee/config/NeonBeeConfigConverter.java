...
/**
 * Converter and mapper for {@link io.neonbee.config.NeonBeeConfig}.
 * NOTE: This class has been automatically generated from the {@link io.neonbee.config.NeonBeeConfig} original class using Vert.x codegen.
 */
   ...
   static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, NeonBeeConfig obj) {
    for (java.util.Map.Entry<String, Object> member : json) {
      switch (member.getKey()) {
        ...
        case "healthConfig":
          if (member.getValue() instanceof JsonObject) {
            obj.setHealthConfig(new io.neonbee.config.HealthConfig((io.vertx.core.json.JsonObject)member.getValue()));
          }
          break;
        case "metricsConfig":
          if (member.getValue() instanceof JsonObject) {
            obj.setMetricsConfig(new io.neonbee.config.MetricsConfig((io.vertx.core.json.JsonObject)member.getValue()));
          }
          break;
          ...
          if (member.getValue() instanceof JsonArray) {
            ...
            ((Iterable<Object>)member.getValue()).forEach( item -> {
              if (item instanceof JsonObject)
                list.add(new io.neonbee.config.MicrometerRegistryConfig((io.vertx.core.json.JsonObject)item));
            });
